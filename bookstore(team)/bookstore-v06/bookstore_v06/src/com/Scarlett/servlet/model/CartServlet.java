...
import com.Scarlett.bean.CartItem;
import com.Scarlett.bean.CommonResult;
...
import com.Scarlett.Utils.JsonUtils;
...
public class CartServlet extends ModelBaseServlet {
    ...
    public void addCartItem(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            if(admin == null){
                ...
                commonResult=CommonResult.success().setMessage("admin");
            }
            //commonResult = CommonResult.success().setResultData(cart.getTotalCount());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    //跳转到显示购物车列表的页面
    public void toCartPage(HttpServletRequest request,HttpServletResponse response) throws IOException, IOException {
