...
public class BookDaoImpl extends BaseDao<Book> implements BookDao {
    ...
    public void deleteBook(Integer bookId) throws SQLException {
        String sql = "deleterom bs_book where book_id=?";
        update(sql,bookId);
    }

    @Override
    public void insertBook(Book book) throws SQLException {
        String sql = "insert into bs_book (book_name,author,price,sales,stock,img_path) values (?,?,?,?,?,?)";
    ...
    public void updateBook(Book book) throws SQLException {
        //我们暂时不修改图片路径
        String sql = "update bs_book set book_name=?,price=?,author=?,sales=?,stock=? where book_id=?";
